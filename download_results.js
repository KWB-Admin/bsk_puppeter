...
const bsk_url = credentials.bsk_url;
...
(async () => {
  ...
  async function set_results_radio_to_90_days() {
    var radio_id = "#woFilterSet";
    var child_id = "#woFilterSet > input[type=radio]:nth-child(3)";
    child_element_click(radio_id, child_id);
  }

  async function set_projects_radio_to_90_days() {
    var radio_id = "#prjFilterSet";
    var child_id = "#prjFilterSet > input[type=radio]:nth-child(3)";
    child_element_click(radio_id, child_id);
  }
  ...
  await set_projects_radio_to_90_days();
  await click_into_general_results_page();
  await set_results_radio_to_90_days();
